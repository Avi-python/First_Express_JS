...
// app.use('/', [logger, authorize]); // 會照順序執行 logger -> authorize
// 我不想要對所有網頁都進行 authorize

app.get('/', (req, res) => {
    res.send(`<h1>Home Page</h1><a href="/api/products">products</a>`);
});

// app.use(logger) 如果 logger 在這邊會使得上面沒有被註冊到 logger
// app.use('/', logger) 也同樣現象
...
app.get('/api/v1/query', [logger, authorize], (req, res) => {
